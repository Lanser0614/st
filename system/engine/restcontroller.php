...
abstract class RestController extends Controller
{
    ...
    public function checkPlugin()
    {
        ...
        $rest_api_licensed_on = $this->config->get('rest_api_licensed_on');
        if (!$this->config->get('rest_api_status') || empty($rest_api_licensed_on)) {
    ...
    public function sendResponse()
    {
        ...
        if ($this->config->get('rest_api_enable_logging')) {
            $this->enableLogging = (int)$this->config->get('rest_api_enable_logging');
        }
    ...
    private function setSystemParameters()
    {
        ...
        $configSecret = $this->config->get('rest_api_key');
