	...
	public function index() {
		...
		if (!isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$data['logout'] = $this->url->link('common/logout', 'token=' . $this->session->data['token'], true);
				...
				$data['contactus'] = $this->url->link('extension/module/contact', 'token=' . $this->session->data['token'], 'SSL');
				$data['total_contact'] = $this->model_contact_contact->getTotalContactinfo();
