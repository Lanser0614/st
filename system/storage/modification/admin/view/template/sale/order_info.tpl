                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td class="text-left"><a
                            ...
                            <?php } ?>
                            <?php } ?></td>
                        <td class="text-left"><?php echo $product['model']; ?>,<?php echo $product['article']; ?></td>
            ...
            <div class="panel-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab-history">
                        <div id="history"></div>
 <?php if (isset($qiwiwpro_link)){ ?>
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $qiwiwprotext; ?></label>
            <div class="col-sm-10"><?php echo $qiwiwpro_link; ?></div>
          </div>
          <?php }
          ?> 
                        <br/>
