...
<div id="content"><?php echo $content_top; ?>
  ...
  <h1><?php echo $heading_title; ?></h1>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right" style="white-space: nowrap;"><?php if ($product['reorder']) { ?>
                <a href="<?php echo $product['reorder']; ?>" data-toggle="tooltip" title="<?php echo $button_reorder; ?>" class="btn btn-primary btn-reorder"></a>
                <?php } ?>
                <a href="<?php echo $product['return']; ?>" data-toggle="tooltip" title="<?php echo $button_return; ?>" class="btn btn-danger btn-return"></a></td>
            </tr>
            <?php } ?>
      ...
      <div class="buttons clearfix">
        <a href="<?php echo $continue; ?>" class="btn btn-primary"><?php echo $button_back; ?></a>
      </div>
