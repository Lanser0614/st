...
class ModelToolYMLOcextDMPRO extends Model {
    ...
    public function getColumns($type_data,$format_data,$odmproyml_tamplate_data) { 
        ...
        $this->load->language('module/'.$format_data.'_ocext_dmpro');
            ...
            if($type_data=='option_value'){
                ...
                foreach ($languages as $language_localisation) {
                    ...
                    if($language_localisation['language_id']==$select_language_id){
                        ...
                        if(file_exists(DIR_LANGUAGE.$language_localisation['directory'].'/catalog/'.$type_data.'.php')){
        ...
        foreach ($offers->offer as $offer) {
            ...
            if($i>=$start && $i < ($limit+$start) && !$skip_empty_group_product_id){
                ...
                if( $type_change=='update_data' || $type_change=='only_update_data' ){
                    ...
                    }elseif ($product_setting['id_column'] && $product_setting['id_column']=='model' && !$offer->model) {
                    ...
                    if($identificator_field && $identificator_value && $table){
                        ...
                        $product = $this->getIdByIdentificator($identificator_field,$identificator_value, $table, $language_id=array());
                    ...
                    if($option_setting['import_status'] && !$skip){
                    ...
                    if($product_setting['image']){
                        ...
                        if($pictures){
                            ...
                            foreach ($pictures as $picture) {
                                ...
                                $images[] = $this->getImageByLink($picture, $product_setting['image_upload']);
                    ...
                    if($manufucaturer_setting['import_status']){
                        ...
                        if(isset($offer->vendor)){
                            ...
                            if($manufacturer_name){
                                ...
                                $manufacturer_id = $this->getManufacturerIdByName($manufacturer_name, $language_id, $odmproyml_tamplate_data['store_id']);
                ...
                if(!$skip){
                    ...
                    if($attribute_setting['import_status']){
                        ...
                        if($params && $product_id){
                            ...
                            $this->setAttributes($params, $attribute_setting['attribute_group_id'], $odmproyml_tamplate_data['language_id'], $product_id);
                ...
                if($option_setting['import_status'] && $import_option && $product_id){
  ...
  public function getCategoryIdByNameAndParentCategoryName($language_id,$yml_category_id,$yml_categories,$store_ids) {
    ...
    public function getImageByLink($site_from_image,$only_image=FALSE) {
        ...
        $image = md5($site_from_image).'.'.end($image_parts);
    ...
    public function exportToCSV($positions,$setting) {
        ...
        $this->load->language('module/abcxyzanalysis');
