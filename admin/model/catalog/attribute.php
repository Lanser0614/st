...
class ModelCatalogAttribute extends Model {
	...
	public function getalldataAttributes($attribute_id) {
      $sql = "SELECT DISTINCT `text`, `language_id` FROM `" . DB_PREFIX . "product_attribute` WHERE attribute_id = '".$attribute_id."'";
      $query = $this->db->query($sql);
