            ...
            <div class="panel-body">
              ...
              <span data-toggle="tooltip" title="" data-original-title="<?php echo $text_secret_key; ?>">
                <?php echo $entry_key; ?>
                  ...
                  <span data-toggle="tooltip" title="" data-original-title="<?php echo $text_enable_logging; ?>">
                    <?php echo $entry_enable_logging; ?>
                  </span>
                        </label>
                        <div class="col-sm-10">
                            <input class="form-control" type="checkbox" name="rest_api_enable_logging" value="1" <?php if($rest_api_enable_logging){ echo('checked');} ?>/>
                        </div>
                    </div>
                    <div class="form-group">
