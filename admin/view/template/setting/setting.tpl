          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="store-language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="config_langdata[<?php echo $language['language_id']; ?>][address]" placeholder="<?php echo $entry_address; ?>" rows="3" id="input-address<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['address'] : ''; ?></textarea>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="config_langdata[<?php echo $language['language_id']; ?>][open]" rows="2" placeholder="<?php echo $entry_open; ?>" id="input-open<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['open'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea name="config_geocode" rows="3" placeholder="<?php echo $entry_geocode; ?>" id="input-geocode" class="form-control"><?php echo $config_geocode; ?></textarea>
                </div>
              </div>
              <div class="form-group required">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <textarea name="config_telephone" rows="3" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone" class="form-control"><?php echo $config_telephone; ?></textarea>
