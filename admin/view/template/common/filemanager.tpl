    ...
    <div class="modal-body">
      ...
      <div class="row">
        ...
        <div class="col-sm-3 col-xs-6 text-center">
          ...
          <?php if(strpos($image['name'],'.pdf') != 0){ ?>
            <a href="<?php echo $image['href']; ?>" data-type="pdf" data-name="<?= $image['name'] ?>" class="thumbnail"><?= $image['name'] ?></a>
            <label>
                <input type="checkbox" name="path[]" value="<?php echo $image['path']; ?>" />
                <?php echo $image['name']; ?></label>
          <?php } else { ?>
          <a href="<?php echo $image['href']; ?>" data-type="jpg" class="thumbnail"><img src="<?php echo $image['thumb']; ?>" alt="<?php echo $image['name']; ?>" title="<?php echo $image['name']; ?>" /></a>
          <label>
            <input type="checkbox" name="path[]" value="<?php echo $image['path']; ?>" />
            <?php echo $image['name']; ?></label>
          <?php } ?>
