        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-model">Артикул (SKU)</label>
                <input type="text" name="filter_model" value="<?php echo $filter_model; ?>" placeholder="Артикул" id="input-model" class="form-control" />
              </div>
