...
class ControllerCatalogProduct extends Controller {
    ...
    $data['manufacturers'] = $this->model_catalog_manufacturer->getManufacturers();
        ...
        $attribute_all_values = $this->model_catalog_attribute->getalldataAttributes($product_attribute['attribute_id']);
        ...
        foreach ($attribute_all_values as $attribute_all_value) {
           $attribute_values[] = array(
             ...
             'langid'          => $attribute_all_value['language_id']
           );
      }
          ...
          'product_attribute_all_value'   => $attribute_values
				);
			}
		}
