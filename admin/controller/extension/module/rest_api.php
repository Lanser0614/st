...
class ControllerExtensionModuleRestApi extends Controller
{
    ...
    public function index()
    {
        ...
        $data = array(
            ...
            'entry_enable_logging' => $this->language->get('entry_enable_logging'),
            'text_enable_logging' => $this->language->get('text_enable_logging'),
        ...
        if (isset($this->request->post['rest_api_enable_logging'])) {
            $data['rest_api_enable_logging'] = $this->request->post['rest_api_enable_logging'];
        } else {
            $data['rest_api_enable_logging'] = $this->config->get('rest_api_enable_logging');
        }
