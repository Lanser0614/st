...
class ControllerExtensionModuleYMLOcextDMPRO extends Controller {
	...
	private $error = array();
		...
		$this->load->language('module/yml_ocext_dmpro');
		...
		$this->load->model('setting/setting');
                ...
                if(file_exists(DIR_APPLICATION.'controller/extension/extension/module/yml_ocext_dmpro.php')){
			...
			$this->session->data['success'] = $this->language->get('text_success');
                        ...
                        $this->response->redirect($this->url->link('extension/module/yml_ocext_dmpro', 'token=' . $this->session->data['token'], 'SSL'));
                ...
                $data['action_setting'] = $this->url->link('extension/module/yml_ocext_dmpro', 'token=' . $this->session->data['token'], 'SSL');
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
                    ...
                    'href'      => $this->url->link('extension/module/yml_ocext_dmpro', 'token=' . $this->session->data['token'], 'SSL'),
                    'separator' => ' :: '
   		);
        ...
        public function getStepOneSettings() {
            ...
            if (!in_array('xml', $allowed)) {
                    ...
                    $link_on_setting = $link = $this->url->link('setting/setting', 'token=' . $this->session->data['token'], 'SSL');
