<?php
// HTTP
define('HTTP_SERVER', 'http://localhost/st-spares-current.ru/admin/');
define('HTTP_CATALOG', 'http://localhost/st-spares-current.ru/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/st-spares-current.ru/admin/');
define('HTTPS_CATALOG', 'http://localhost/st-spares-current.ru/');

// DIR

define('DIR_APPLICATION', '/opt/lampp/htdocs/st-spares-current.ru/admin/');
...
define('DIR_LANGUAGE', '/opt/lampp/htdocs/st-spares-current.ru/admin/language/');
define('DIR_TEMPLATE', '/opt/lampp/htdocs/st-spares-current.ru/admin/view/template/');
...
define('DIR_CATALOG', '/opt/lampp/htdocs/st-spares-current.ru/catalog/');
