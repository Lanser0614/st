...
<div class="container">
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <input type="hidden" name="payment_code" value="<?php echo $fpay_currency_code; ?>" /> 
          <div class="form-group">
              <label for="psum"><?php echo $text_fpay_sum; ?></label>
              <input class="form-control" type="text" id="psum" name="payment_sum" value="" placeholder="<?php echo $entry_fpay_sum; ?>" required="required" />
          </div>
          <div class="form-group">
              <label for="email"><?php echo $text_fpay_email; ?></label>
              <input class="form-control" type="email" id="email" name="email" value="" required="required" />
          </div>
          <div class="form-group">
              <label for="phone"><?php echo $text_fpay_phone; ?></label>
              <input class="form-control" type="tel" id="phone" name="phone" value="" />
          </div>
          <div class="form-group">
              <label for="comment"><?php echo $text_fpay_comment; ?></label>
              <textarea class="form-control" id="comment" name="comment" /></textarea>
          </div>
          <div class="form-group">
      <p><?php echo $text_fpay_method; ?></p>
