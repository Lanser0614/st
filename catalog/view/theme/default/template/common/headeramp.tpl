...
<head>
    ...
    <meta name="description" content="Большой выбор оригинальных запчастей для грузовых автомобилей ISUZU, MITSUBISHI, HINO и других. Продажа оптом и в розницу по ценам производителя. Гарантия. Доставка по России. " />
    ...
    <link rel="canonical" href="https://st-spares.ru/chart/EURUSD/poLlG2FD-EUR-USD-Daily-Chart-Analysis-8-12/" />
...
<header>
    ...
    <div id="header">
        <div class="container">
            ...
            <div id="logo">
                <?php if ($home == $og_url) { ?>
                <amp-img src="<?php echo $logo; ?>" title="<?php echo $name; ?>"
                         alt="<?php echo $name; ?>" layout="responsive" width="127" height="52">
                </amp-img>
                <?php } else { ?><a href="<?php echo $home; ?>">
                    <amp-img src="<?php echo $logo; ?>" title="<?php echo $name; ?>"
                             alt="<?php echo $name; ?>" layout="responsive" width="127" height="52"></amp-img>S T - S P A R E S . R U</a><?php } ?>
            </div>

            <div id="slogan">
                <amp-img src="image/catalog/slogannew.png" alt="slogannew" layout="responsive" width="320" height="53"></amp-img>
                автомобилей с доставкой по России
            </div>
            ...
            <div id="search"><input type="text" name="search" placeholder="<?php echo $text_search; ?>"/><i
                        class="icon attractYellow"></i></div>
