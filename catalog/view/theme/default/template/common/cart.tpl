<div id="cart">
    ...
    <div id="flycart">
        <div id="flycart-content">
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" onclick="voucher.remove('<?php echo $voucher['key']; ?>');"
                                title="<?php echo $button_remove; ?>" class="btn btn-danger btn-xs"></button>
                    </td>
                </tr>
                <?php } ?>
            </table>
            ...
            <?php }else{ ?>
            <div class="ttl"><span><?php echo $totals[0]['title']; ?>:</span>
                <span><?php echo $totals[0]['text']; ?></span></div>
            <div class="pull-center"><a class="btn" href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a>
            </div>
            <?php }?>
        </div>
    </div>
