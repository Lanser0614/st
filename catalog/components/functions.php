...
function detailsTblRowCreate($item) {
    $html = '';
    $html.= "<tr>";
    $html.="<td>" . $item->NameOfCatalog . "</td>";
    $html.="<td>" . $item->ShotNumber . "</td>";
    $html.="<td>" . $item->NameRus . "</td>";
    ...
    $html.="<td>" . $item->NumberOfDaysSupply . "</td>";
    ...
    $html.= <button type='submit' class='glyphicon glyphicon-shopping-cart'></button>
    $html.= <input type='hidden' value='".$item->IdDetail."' name='IdDetail' />
    $html.= <input type='hidden' value='".$item->NameOfCatalog."' name='NameOfCatalog' />
    $html.= <input type='hidden' value='".$item->SalePrice."' name='SalePrice' />
    $html.= <input type='hidden' value='".$item->DeliveryDate."' name='DeliveryDate' />
    $html.= <input type='hidden' value='".$item->NameRus."' name='NameRus' />
    $html.= <input type='hidden' value='".$item->Number."' name='Number' />
