...
{
    /**
     * @var ModelExtensionPaymentYandexMoneyB2bSberbank
     */
    private $_model;
    ...
    public function applyTemplateVariables($controller, &$templateData, $orderInfo)
    {
        ...
        $templateData['validate_url']    = $controller->url->link($this->getPrefix().'payment/yandex_money_b2b_sberbank/create',
            '', true);
        ...
        return 'payment/yandex_money/kassa_form_b2b';
    }
    ...
    /**
     * @return ModelExtensionPaymentYandexMoneyB2bSberbank
     */
    public function getModel()
    {
        if ($this->_model === null) {
            $this->load->model($this->getPrefix().'payment/yandex_money_b2b_sberbank');
            if ($this->getPrefix() === '') {
                $this->_model = $this->model_payment_yandex_money_b2b_sberbank;
            } else {
                $this->_model = $this->model_extension_payment_yandex_money_b2b_sberbank;
            }
        }
...
class ControllerPaymentYandexMoneyB2bSberbank extends ControllerExtensionPaymentYandexMoneyB2bSberbank
{
}
