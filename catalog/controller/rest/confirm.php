...
class ControllerRestConfirm extends RestController
{
    ...
    public function saveOrderToDatabase()
    {
        ...
        if (isset($this->session->data['order_id'])) {
            $order_status_id = 1;
            $cod_status = $this->config->get('cod_order_status_id');
            ...
            if (!isset($this->session->data['payment_method']) || empty($this->session->data['payment_method'])) {
                ...
                if (empty($status)) {
                    $defaultStatus = $this->config->get($this->session->data['payment_method']['code'] . '_order_status_id');
        ...
        if (empty($this->json["error"])) {
            ...
            if (empty($this->json["error"])) {
                ...
                if (isset($this->session->data['tracking']) && !empty($this->session->data['tracking'])) {
                    ...
                    $affiliate_info = $this->model_affiliate_affiliate->getAffiliateByCode($this->session->data['tracking']);
