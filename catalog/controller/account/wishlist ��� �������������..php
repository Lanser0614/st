...
class ControllerAccountWishList extends Controller {
	public function index() {
		...
		if (isset($this->request->get['remove'])) { // Remove Wishlist
			
			if ($this->customer->isLogged()) {
			  $this->model_account_wishlist->deleteWishlist($this->request->get['remove']);
      } else {
				$key = array_search($this->request->get['remove'], $this->session->data['wishlist']);
			  if ($key !== false) unset($this->session->data['wishlist'][$key]);
			}
		...
		if ($this->customer->isLogged()) {
			...
			if (isset($this->session->data['wishlist'])) $results = $this->session->data['wishlist'];
			else $results = array();
		}
