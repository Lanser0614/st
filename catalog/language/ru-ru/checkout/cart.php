...
// Text
$_['text_success']             = '<div class="title">Товар добавлен в корзину!</div><div class="tvr"><div><img src="%s" /></div><div><b>%s</b></div></div><div class="chce"><span class="close">Продолжить покупки</span> &nbsp; <a class="btn" href="%s">Оформить заказ</a></div>';
