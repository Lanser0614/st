<?php
$_['error_no_odmproyml_update_yml_link'] = 'ERR. 1 - Нет данных для автобоновления';
...
include_once $_SERVER['DOCUMENT_ROOT'] .   '/admin/language/russian/module/yml_ocext_dmpro.php';
